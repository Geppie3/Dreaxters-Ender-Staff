...
/** Registers the extra baked model consumed by the Ender Staff item renderer. */
@Mod.EventBusSubscriber(modid = EnderStaves.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
